...
using WWW58COM.SPAT.SCF.Client.Communication.Protocol.SFP;
using WWW58COM.SPAT.SCF.Client.Configuration.Commmunication;
using WWW58COM.SPAT.SCF.Client.Exceptions;
using WWW58COM.SPAT.SCF.Client.Utility.Helper;
...
namespace WWW58COM.SPAT.SCF.Client.Communication.Scoket
{
    internal class CSocket : IDisposable
    {
        ...
        private Dictionary<int, ChannelData> ReceiveChannel = new Dictionary<int, ChannelData>();
        ...
        private void Receive()
        {
            ...
            if (ReceiveChannel.TryGetValue(pSessionId, out channelData))
            {
    ...
    {
        public ChannelData(AutoResetEvent even)
        {
            Event = even;
        }
