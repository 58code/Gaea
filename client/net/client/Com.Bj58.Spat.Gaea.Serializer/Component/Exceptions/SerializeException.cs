...
namespace Com.Bj58.Spat.Gaea.Serializer.Component.Exceptions
{
    ...
    {
        private string _msg = "serialize error!";
        private StringBuilder _stackTrace = new StringBuilder();
        ...
        {
            _msg = innerException.Message;
            _stackTrace.AppendLine(innerException.StackTrace);
        }
